...
await update.message.reply_text(‘سلام 👋’, reply_markup=main_keyboard(uid, admin_id))
...
await update.message.reply_text(‘❌ فرمت: /remove <index> <plan 1-5>’)
...
if data.startswith('approve|'):
    ...
    try:
        ...
        return
    await q.message.edit_caption('✅ کانفیگ ارسال شد.')
    return
